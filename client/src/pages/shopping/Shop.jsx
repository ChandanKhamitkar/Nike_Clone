...
function Shop() {
    ...
    const handleBag = async (e) => {
        ...
        try {
            const response = await axios.post(`http://localhost:3010/api/user/addToBag`, addBagItem);
    ...
    const handleFavourite = async (e) => {
        ...
        try {
            const response = await axios.post(`http://localhost:3010/api/user/addToFavourite`, addBagItem);
